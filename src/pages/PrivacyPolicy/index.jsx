    ...
    <>
      ...
      >
        ...
        <Typography variant="body2" paragraph>
          ...
          Portal, you agree to the following terms: Prohibited Actions: You must
          ...
          of the Company. Automated Access: You are prohibited from using any
          automated software, algorithms, or manual processes to scrape, crawl,
          or copy any Content or information from the Portal. Fair Usage: You
          must not use the Portal in any manner that could damage, disable,
          overburden, or impair its functionality, or interfere with any other
          party's use and enjoyment of the Portal. Account Security: Account
          holders are solely responsible for maintaining the confidentiality of
          their account login credentials. Any activity that occurs under your
        ...
        <Typography variant="body2" paragraph>
          ...
          timeframe after receiving an Order. Estimated delivery times are
          provided at the time of order placement but are subject to
          availability and other logistical considerations. Shipping Timeframe:
